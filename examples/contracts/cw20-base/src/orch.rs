...
// Maybe uploadable can be autogenerated without too much work?
...
// generate inside the `sv::messages` macro rather than the `contract` macro.
// If you camelcase the module name and add {ExecMsg,QueryMsg,SudoMsg} you get the type.
// The module and the variant are already there...
